          ...
          animate={{
            boxShadow:
              scrollYProgress.get() > 0
                ? "none"
                : "rgba(6, 182, 212, 0.24) 0px 0px 24px 8px",
          }}
          className="ml-[27px] h-4 w-4 rounded-full border border-cyan-500 flex items-center justify-center p-0.5"
        >
          <motion.div
            animate={{
              backgroundColor:
                scrollYProgress.get() > 0 ? "white" : "var(--cyan-500, #06b6d4)",
              borderColor:
                scrollYProgress.get() > 0 ? "white" : "var(--cyan-600, #0891b2)",
            }}
